...
function HomeScreen({ navigation }) {
  ...
  const openChrome = () => {
    console.log("fff");
    const url = 'https://huggingface.co/spaces/saptharishi/aibot'; // Replace this with your desired URL
    handleOpenURL(url);
  };
...
function Logscreen({ navigation }) {
  ...
  const resetData = () => {
    ...
    // Set the data in these nodes to null to delete them
    update(diseaseRef, {});
    update(pestRef, {});
    ...
    // Show an alert or confirmation message if needed
...
export function PestScreen({ navigation }) {
  ...
  const url = "http://192.168.46.238:5000";
  return (
    <ScrollView style={styles.pestcon}>
      <View style={styles.box_co}>
        {/* cam 1 */}
        <TouchableOpacity onPress={() => openLink(url+'/pcam1')}>
        ...
        {/* cam2  */}
        <TouchableOpacity onPress={() => openLink(url+'/pcam2')}>
      ...
      <View style={styles.box_co}>
      <TouchableOpacity onPress={() => openLink(url+'/pcam3')}>
        ...
        <TouchableOpacity onPress={() =>openLink(url+'/pcam4')}>
      ...
      <TouchableOpacity onPress={() => openLink(url+'/pcam5')}>
      ...
      <TouchableOpacity onPress={() => openLink(url+'/pcam6')}>
...
export function DiseaseScreen({ navigation }) {
  ...
  return (
    <ScrollView style={styles.pestcon}>
      <View style={styles.box_co}>
      <TouchableOpacity onPress={() =>openLink(url+'/dcam1')}>
      ...
      <TouchableOpacity onPress={() =>openLink(url+'/dcam2')}>
      ...
      <View style={styles.box_co}>
      <TouchableOpacity onPress={() =>openLink(url+'/dcam3')}>
      ...
      <TouchableOpacity onPress={() =>openLink(url+'/dcam4')}>
      ...
      <View style={styles.box_co}>
      <TouchableOpacity onPress={() =>openLink(url+'/dcam5')}>
      ...
      <TouchableOpacity onPress={() =>openLink(url+'/dcam6')}>
      ...
      <View style={styles.box_co}>
      <TouchableOpacity onPress={() =>openLink(url+'/dcam7')}>
      ...
      <TouchableOpacity onPress={() =>openLink(url+'/dcam8')}>
          ...
          options={({ navigation }) => ({
            ...
            headerRight: () => (
              <Ionicons
                ...
                onPress={() => navigateToLogScreen(navigation,Logscreen)}
              />
            ),
          })}
        />
